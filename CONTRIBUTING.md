...
* ramsey/pygments follows a superset of **[PSR-12 coding standard][psr-12]**.
...
versions of PHP and [virtualenv](http://docs.python-guide.org/en/latest/dev/virtualenvs/)
and [virtualenvwrapper](https://virtualenvwrapper.readthedocs.io/en/latest/)
for running multiple versions of Python and Pygments. When using these tools,
you may switch between environments to run the tests. Our
[GitHub Actions](https://github.com/ramsey/pygments/blob/.github/workflows/continuous-integration.yml)
configuration has more information about the versions of PHP, Python, and
Pygments we test against.

#### Example Using virtualenvwrapper To Run Tests

The following are the commands you might run if you wish to test this library
against Pygments version 2.8. See the
[virtualenvwrapper](https://virtualenvwrapper.readthedocs.io/en/latest/)
documentation, for more information on the `mkvirtualenv` and `deactivate`
commands.

```shell
mkvirtualenv pygments-2.8
pip install Pygments==2.8
composer test
deactivate
```

[github]: https://github.com/ramsey/pygments
[issues]: https://github.com/ramsey/pygments/issues
[pull requests]: https://github.com/ramsey/pygments/pulls
